...
exports.addStory = (req, res) => {
  res.render("editStory", { title: "Add a Story" }); //use same template for add and edit story
};
...
exports.createStory = async (req, res) => {
  ...
  req.flash(
    "success",
    `Successfully Created the Story, ${capitalizeFirstLetter(story.slug)}.`
  );
...
exports.editStory = async (req, res) => {
  ...
  res.render("editStory", {
    title: `Edit the Story, ${capitalizeFirstLetter(story.slug)}`,
    story
  });
};
...
exports.updateStory = async (req, res) => {
  ...
  req.flash(
    "success",
    `Successfully updated <strong>${story.slug}</strong>. <a href="/story/${story.slug}">View story →</a>`
  );
...
exports.deleteStory = async (req, res) => {
  ...
  req
    .checkBody("agreement", "You must acknowledge this is irreversible!")
    .equals("on");
